...
# %%
extremes = evext.EventExtreme(single_data)
...
# %%
mextremes = evext.EventExtreme(data, independent_dim='plev')

# %%
mextremes.pos_abs_thr = pos_threshold
# %%
mextremes.extract_positive_extremes
# %%
